...
cities = ['Киев', 'Львов', ' ', 'Днепропетровск',
          'Харьков', 'Донецк', 'Запорожье', 'Кривой Рог',
          'Полтава', 'Херсон',  'Черкассы', 'Черновцы',
          'Тернополь', 'Ужгород', 'Николаев', 'Миргород',
          'Хмельницкий', 'Александровка', 'Чернигов',
          'Антоновка', 'Белгород', 'Бровары', 'Волгодонск',
          'Гатчина', 'Дубно', 'Евпатория', 'Житомир', 'Ровно',
          'Винница', 'Кропивницкий', 'Луцк', 'Львов',
          ]
